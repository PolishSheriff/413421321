					...
					if permissions["player.call"] then
						...
						thisItem.Activated = function(ParentMenu,SelectedItem)
							...
							if result and result ~= "" then
								...
								reason = GetLocalisedText("noreason")
							end

							TriggerServerEvent("EasyAdmin:CallThePlayer", thePlayer.id, reason)
						end
					end
		...
		if drawInfo then
			...
			if (not RedM) then 
				...
				for i,theText in pairs(text) do
					...
					SetTextOutline()
					SetTextEntry("STRING")
					AddTextComponentString("<font face='Poppins-Medium' size= '15'>".. theText .."</font>" )
